...
|---|---|---|
| `pb2egg.py` | protobuf → egg rewrite rules | Full-op (conv/pool/concat/matmul/transpose), `--multi-out` saves multi-output rewrites. Enlarge/const_*/split still dropped (PROBLEMATIC.md #8). |
